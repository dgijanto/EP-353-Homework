...
#define kOutputFileName "fuzzflanger2.wav"
...
void process2(float *inBuffer, float *outBuffer, sf_count_t bufferSize);
...
int main(){
  ...
  process(inBuffer, outBuffer, bufferSize); // flanger
  process2(inBuffer, outBuffer, bufferSize); // fuzz
